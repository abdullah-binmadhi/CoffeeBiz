-- CoffeeBiz Analytics Database Schema
-- PostgreSQL Database Schema for Coffee Shop Analytics
...
CREATE TABLE products (
    ...
    base_price DECIMAL(8,2), -- Base price if available
...
CREATE TABLE transactions (
    ...
    card_number VARCHAR(255), -- Store card info for linking customers
...
-- Daily revenue summary table (materialized view for performance)
